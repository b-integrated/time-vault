...
function HarvestImport({ user }) {
  ...
  const importConfigs = {
    ...
    invoices: {
      ...
      help: 'Upload a Harvest invoice JSON export. Existing invoices are updated by Harvest ID or invoice number, including status, totals, due amount, subject, notes, and address fields when present.'
    }
  };
